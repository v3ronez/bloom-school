  ...
  <div class="header">
    <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Bloom School</a>
    ...
    <section class="container">
      <div class="image-hero">
        <div class="d-flex flex-column p-4 text-center">
          <h1>Aprenda ingles de uma forma divertida</h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae assumenda ea commodi, autem a ratione est
          </p>
        </div>
        <dotlottie-player src="https://lottie.host/dea2b10a-1bcb-4c6a-a5d4-cd22e7ef241f/7H2fk4dtWh.json"
          background="#003366" speed="1" style="width: 300px; height: 300px" direction="1" playMode="normal" loop
          autoplay></dotlottie-player>
        <button class="button-34" role="button">Saiba mais <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
